  ...
  head: () => ({
    meta: [
      { title: "Life Replay — The AI Memory Operating System" },
      {
        name: "description",
        content:
          "Capture, replay, and understand your life with an AI that remembers what matters.",
      },
...
function Hero() {
  return (
    <section className="relative mx-auto max-w-7xl px-6 pt-20 md:pt-32 pb-32 text-center">
      ...
      >
        <span className="text-aurora glow-text-cyan">Replay your life.</span>
        <br />
      ...
      >
        Capture moments, feelings, and ideas. An emotionally intelligent AI weaves them into a
        living universe you can search, replay, and feel — forever.
      </motion.p>
...
const FEATURES = [
  {
    ...
    body: "Your memories are read with empathy. The AI surfaces themes, moods, and the threads connecting them.",
  },
  {
    icon: Orbit,
    title: "A Living Memory Galaxy",
    body: "Watch your life form constellations. Moments cluster, glow, and orbit by emotion and meaning.",
  },
  {
    icon: Search,
    title: "Search Like You Think",
    body: "Ask in natural language: 'late-night ideas', 'when I felt brave', 'conversations that mattered.'",
  },
  {
    icon: Play,
    title: "Cinematic Replay",
    body: "Re-experience curated moments. On This Day, this mood, this person — wrapped in light.",
  },
  {
    icon: Heart,
    title: "Private by Design",
    body: "Your memories belong to you. End-to-end care, on-device first, encrypted in transit.",
  },
  {
    icon: Zap,
    title: "Effortless Capture",
    body: "Type, speak, or upload an image. The AI handles tags, summaries, and connections.",
  },
];
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-24">
      <div className="mb-16 text-center">
        ...
        <h2 className="font-display text-4xl md:text-5xl font-semibold tracking-tight text-aurora">
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-24">
      <div className="mb-12 text-center">
        <h2 className="font-display text-4xl md:text-5xl font-semibold tracking-tight text-aurora">
          A glimpse of your replay
        </h2>
        <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
          Preview of what your weeks will feel like.
        </p>
      </div>
        ...
        <div className="relative grid items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Every moment is a star. Every emotion, a constellation. The AI maps the gravitational
              pull between your experiences — so the shape of your inner life becomes visible.
            </p>
            <Link
              to="/onboarding"
...
const TESTIMONIALS = [
  {
    name: "Aria N.",
    role: "Designer",
    quote: "It's the first product that made my own life feel cinematic.",
  },
  {
    name: "Kenji R.",
    role: "Founder",
    quote: "I searched 'when I felt brave' and watched my year reframe itself.",
  },
  {
    name: "Mira S.",
    role: "Writer",
    quote: "Like a journal that finally listens — and remembers like a friend.",
  },
];
