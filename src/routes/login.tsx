    ...
    <div className="relative min-h-screen">
      ...
      <div className="mx-auto grid min-h-screen max-w-6xl items-center gap-12 px-6 py-16 md:grid-cols-2">
        <div className="hidden md:flex flex-col items-center text-center">
          ...
          <Link to="/" className="mt-12 text-sm text-muted-foreground hover:text-foreground">
            ← Back to Life Replay
          </Link>
        </div>
        <motion.div
        ...
        >
          <h1 className="font-display text-3xl font-semibold tracking-tight text-aurora">
            {title}
          </h1>
